...
class VendorScraper(ABC):
    ...
    def refresh_session(self, login_url: str = None) -> bool:
        ...
        print(f"   2. Navigate to the main product/ordering page")
        print(f"   3. Return here and press Enter when done")
        ...
        try:
            ...
            print(f"  Session valid for 30 days")
                    ...
                    try:
                        ...
                        if price_data:
                            ...
                            self.db.add_price(
                                ...
                                unit=price_data.get('unit', item.get('default_unit', 'Each')),
                                source='scrape',
    ...
    def extract_price_from_page(self, page: Any, item_name: str) -> Optional[Dict]:
        ...
        try:
            ...
            for selector in price_selectors:
                ...
                if elements:
                    price_text = elements[0].inner_text()
                    # Parse price
            ...
            if selectors.get('price_selector'):
                element = page.query_selector(selectors['price_selector'])
                if element:
...
def run_weekly_scrape() -> Dict:
    ...
    for scraper in scrapers:
        ...
        if not scraper.has_valid_session():
            print(f"  ⚠️ No valid session. Skipping.")
